...
-- SIFRA JE 'author'
insert into author(id, email, password, firstname, lastname) values (-1, 'author@gmail.com', '$2y$12$/2zhcxjmhArGzkzb.idyCuYaz1B54vliIP2cMAP/mGtRBVQkjTxda', 'ivkovic', 'djordje');
